...
# Download the parsec tar using wget on your /scratch/<netid>
# extract the tar
# go to parsec/bin
# run source env.sh
# put this script there
# run the script with nohup python3 parsec_dataset_creator.py &
...
# parse results for real time metric
